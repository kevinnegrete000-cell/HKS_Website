...
async function initAtlasView(){
  ...
  const continentMaterial=new THREE.LineBasicMaterial({color:0xe0e3dc,transparent:true,opacity:.46,depthWrite:false});
...
console.info('[HKS] Atlas v4.1 loaded — arc-safe globe build');
